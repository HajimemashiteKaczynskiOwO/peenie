...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav data-svelte-h="svelte-15hp6iz"><div class="links svelte-1g0ybkp"><a href="${escape(base, true) + "/"}" class="svelte-1g0ybkp"><b>Beautiful House</b></a> <a href="${escape(base, true) + "/photoapp"}" class="svelte-1g0ybkp"><b>The Wondrous and Amazing Photo App</b></a> <a href="${escape(base, true) + "/about"}" class="svelte-1g0ybkp"><b>About</b></a> <a href="${escape(base, true) + "/register"}" class="svelte-1g0ybkp"><b>Register</b></a> <a href="${escape(base, true) + "/login"}" class="svelte-1g0ybkp"><b>Login</b></a></div></nav>   ${slots.default ? slots.default({}) : ``}`;
});
export {
  Layout as default
};
