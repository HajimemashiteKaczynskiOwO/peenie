...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav data-svelte-h="svelte-k5r6fa"><div class="links svelte-1t5ubfh"><a href="${escape(base, true) + "/"}" class="svelte-1t5ubfh"><b>Beautiful House</b></a> <a href="${escape(base, true) + "/photoapp"}" class="svelte-1t5ubfh"><b>The Wondrous and Amazing Photo App</b></a> <a href="${escape(base, true) + "/shoppinglist"}" class="svelte-1t5ubfh"><b>Shopping List</b></a> <a href="${escape(base, true) + "/search"}" class="svelte-1t5ubfh"><b>Pokésearch</b></a> <a href="${escape(base, true) + "/register"}" class="svelte-1t5ubfh"><b>Register</b></a> <a href="${escape(base, true) + "/login"}" class="svelte-1t5ubfh"><b>Login</b></a> <a href="${escape(base, true) + "/memory"}" class="svelte-1t5ubfh"><b>Memory</b></a> <a href="${escape(base, true) + "/chat"}" class="svelte-1t5ubfh"><b>DroydAI</b></a></div></nav>   ${slots.default ? slots.default({}) : ``}`;
});
export {
  Layout as default
};
