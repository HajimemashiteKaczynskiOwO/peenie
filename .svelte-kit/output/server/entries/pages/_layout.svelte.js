...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav data-svelte-h="svelte-o6d53g"><div class="links svelte-1334ea9"><a href="${escape(base, true) + "/"}" class="svelte-1334ea9"><b>Beautiful House</b></a> <a href="${escape(base, true) + "/photoapp"}" class="svelte-1334ea9"><b>The Wondrous and Amazing Photo App</b></a> <a href="${escape(base, true) + "/shoppinglist"}" class="svelte-1334ea9"><b>Shopping List</b></a> <a href="${escape(base, true) + "/search"}" class="svelte-1334ea9"><b>Pokésearch</b></a> <a href="${escape(base, true) + "/register"}" class="svelte-1334ea9"><b>Register</b></a> <a href="${escape(base, true) + "/login"}" class="svelte-1334ea9"><b>Login</b></a> <a href="${escape(base, true) + "/memory"}" class="svelte-1334ea9"><b>Memory</b></a> <a href="${escape(base, true) + "/chat"}" class="svelte-1334ea9"><b>DroydAI</b></a> <a href="${escape(base, true) + "/diffShit"}" class="svelte-1334ea9"><b>Trials</b></a></div></nav>   ${slots.default ? slots.default({}) : ``}`;
});
export {
  Layout as default
};
