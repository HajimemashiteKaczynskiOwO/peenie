...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return ` <main class="svelte-pthbrd" data-svelte-h="svelte-a6d5e"><div class="svelte-pthbrd"><h1><strong>George Flowberry</strong></h1> <h2>Since my time in Tilted Towres.. I have figured out how to successfully fabricate a 20 dollar vbuck card...!</h2> <h3>This is how i Did it:</h3> <img src="src/images/fact.png" alt="teeee">  <p id="inspo">&quot;We need to build a reinforced metal wall.&quot; - <strong>Donald Pump</strong>, The 45Th Victory Royale winner in Tilted Towers.</p> <p style="background-color:pink">&quot;I Actually came here just to pick up a Slurpfish.&quot; - <span>EatDatSlurpfish445, Pedophile.</span>.</p>
.
.
.
</div>  </main>`;
